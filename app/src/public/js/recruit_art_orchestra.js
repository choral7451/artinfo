const pageButton = () => {
    ...
    document.getElementById('left').addEventListener('click', ()=> {
        ...
        document.getElementById('left').setAttribute('href', `http://localhost:3000/recruit_art/orchestra?id=${getQueryString}`);
    });        
    ...
    document.getElementById('right').addEventListener('click', ()=> {
        ...
        document.getElementById('right').setAttribute('href', `http://localhost:3000/recruit_art/orchestra?id=${getQueryString}`);
    })
