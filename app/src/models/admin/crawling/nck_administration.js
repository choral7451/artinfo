...
module.exports = {
  Nck_administration : async () => {
    let data = [];
    try {
      return await axios.get('http://nationalchorus.or.kr/notice-2/?mode=list&board_name=notice_new&order_by=fn_pid&order_type=desc&category1=&category2=&category3=&search_field=fn_title&search_text=%EC%A7%81%EC%9B%90')
      .then((html) => {        
      ...
      data.push(["Nck_administration 에러"])
      return data;
    }
  }
}
